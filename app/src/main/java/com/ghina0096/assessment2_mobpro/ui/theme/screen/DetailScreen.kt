...
fun DetailScreen(navController: NavHostController, id: Long? = null){
    ...
    var namaMasakan by remember { mutableStateOf("") }
    var isiResep by remember { mutableStateOf("") }
    ...
    Scaffold (
        topBar = {
            TopAppBar(
                ...
                title = {
                    if (id == null)
                        stringResource(id = R.string.tambah_resep)
                    else
                        stringResource(id = R.string.edit_resep)
                ...
                actions = {
                    IconButton(onClick = {
                        if (namaMasakan == "" || isiResep == "") {
                            Toast.makeText(context, R.string.invalid, Toast.LENGTH_LONG).show()
                            return@IconButton
                        }
                        if (id == null) {
                            viewModel.insert(namaMasakan, isiResep)
                        } else {
                            viewModel.update(id, namaMasakan, isiResep)
                        }
        ...
        FormResep(
            title = namaMasakan,
            onTitleChange = { namaMasakan = it },
            desc = isiResep,
            onDescChange = { isiResep = it },
...
fun FormResep(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = {Text(text = stringResource(R.string.isi_resep))},
            keyboardOptions = KeyboardOptions(
